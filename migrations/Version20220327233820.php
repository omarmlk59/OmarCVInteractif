 ...
 */
final class Version20220327233820 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE experience "id" INT NOT NULL, user_id_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, begin_date DATE NOT NULL, end_date DATE NOT NULL, description VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)');
        ...
        $this->addSql('INSERT INTO public."user"  first_name, last_name, age, email, adress, phone, date_of_birth, city, "degree", photo VALUES (0,"Omar","Abdelmalek",28,"omarmalek@hotmail.fr","60 rue de la justice","0777262896",2022-03-03,"Lille","BACK + 4","./image") ');
    }
